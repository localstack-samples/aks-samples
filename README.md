...
| [keda](tutorials/keda/) | Three event-driven autoscaling tutorials built on the [KEDA add-on](https://learn.microsoft.com/en-us/azure/aks/keda-about): a containerized Python producer fills an [Azure Service Bus](https://learn.microsoft.com/en-us/azure/service-bus-messaging/service-bus-messaging-overview) queue, an [Azure Storage](https://learn.microsoft.com/en-us/azure/storage/queues/storage-queues-introduction) queue or an [Azure Event Hubs](https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-about) hub, and a `ScaledObject` scales the consumer from zero to four replicas and back. The Service Bus and Storage Queue scalers authenticate with [Microsoft Entra Workload ID](https://learn.microsoft.com/en-us/azure/aks/keda-workload-identity), and all three share one user-assigned managed identity so they can coexist on the same cluster. |
