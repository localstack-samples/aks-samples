"""Flask application for managing vacation activities backed by MySQL."""
import datetime
import hashlib
import logging
import os
...
db_client: MySQLClient = MySQLClient.from_env()
...
@app.route("/health")
def health():
    """Liveness and readiness probe: reports whether MySQL answers SELECT 1."""
    try:
        db_client.ping()
