...
| [`secret.yml`](scripts/secret.yml) | Creates the Secret holding sensitive values (the PostgreSQL password and the Flask secret key) passed to the app as environment variables. |
