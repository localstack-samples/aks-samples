...
SECRET_KEY=$(kubectl get secret vacation-planner-postgres-secrets --namespace $NAMESPACE --output jsonpath='{.data.SECRET_KEY}' 2>/dev/null | base64 --decode 2>/dev/null)
