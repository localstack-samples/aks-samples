...
FLASK_SECRET_KEY=$(kubectl get secret vacation-planner-sql-secrets --namespace $NAMESPACE --output jsonpath='{.data.FLASK_SECRET_KEY}' 2>/dev/null | base64 --decode 2>/dev/null)
