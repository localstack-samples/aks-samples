...
# Every setting below still arrives as a plain environment variable; what changed is where those values
...
logger.info("Configuration version: %s", os.environ.get("CONFIG_VERSION", "n/a"))
